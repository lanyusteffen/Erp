...
class UtilsService {
    ...
    closestParent(element, selector) {
        ...
        const /** @type {?} */ match = /** @type {?} */ (element.querySelector(selector));
...
class DayCalendarService {
     ...
     */
    getConfig(config) {
        const /** @type {?} */ _config = /** @type {?} */ (Object.assign({}, this.DEFAULT_CONFIG, this.utilsService.clearUndefined(config)));
...
class TimeSelectService {
    ...
    getConfig(config) {
        ...
        const /** @type {?} */ _config = /** @type {?} */ (Object.assign({}, this.DEFAULT_CONFIG, this.utilsService.clearUndefined(config), timeConfigs));
...
class DayTimeCalendarService {
    ...
    updateDay(current, day, config) {
        const /** @type {?} */ time = current ? current : moment$4();
        let /** @type {?} */ updated = moment$4(day.format(DAY_FORMAT) + time.format(TIME_FORMAT), COMBINED_FORMAT);
        if (config.min) {
            const /** @type {?} */ min = /** @type {?} */ (config.min);
            updated = min.isAfter(updated) ? min : updated;
        }
        if (config.max) {
            const /** @type {?} */ max = /** @type {?} */ (config.max);
    ...
    updateTime(current, time) {
        const /** @type {?} */ day = current ? current : moment$4();
...
class DatePickerService {
    ...
    getConfig(config, mode = 'daytime') {
        const /** @type {?} */ _config = /** @type {?} */ (Object.assign({}, this.defaultConfig, { format: this.getDefaultFormatByMode(mode) }, this.utilsService.clearUndefined(config)));
        this.utilsService.convertPropsToMoment(_config, _config.format, ['min', 'max']);
