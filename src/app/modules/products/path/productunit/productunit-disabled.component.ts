...
@Component({
  selector: 'app-products-productunit-disabled',
  template: `
  <div class="actions">
  ...
  <div class="content">
    <app-productunit-disabled-list (selectItems)="selectItems($event)"></app-productunit-disabled-list>
  </div>
  `,
  styles: [`
    :host {
...
export class ProductUnitDisabledComponent implements OnInit, OnDestroy {
  ...
  onSearch(queryKey) {
    this.productUnitService.onSearchDisabled(queryKey, (err) => {
