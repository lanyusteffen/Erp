...
@Component({
  selector: 'app-products-productcolor-disabled',
  template: `
  <div class="actions">
  ...
  <div class="content">
    <app-productcolor-disabled-list (selectItems)="selectItems($event)"></app-productcolor-disabled-list>
  </div>
  `,
  styles: [`
    :host {
...
export class ProductColorDisabledComponent implements OnInit, OnDestroy {
  ...
  onSearch(queryKey) {
    this.productColorService.onSearchDisabled(queryKey, (err) => {
